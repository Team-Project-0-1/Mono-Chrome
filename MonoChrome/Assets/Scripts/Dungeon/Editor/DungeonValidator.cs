...
namespace MonoChrome.Dungeon.Editor
{
    ...
    public class DungeonValidator : EditorWindow
    {
        ...
        private void DrawManagerSection()
        {
            ...
            dungeonManager = (DungeonManager)EditorGUILayout.ObjectField("DungeonManager:", dungeonManager, typeof(DungeonManager), true);
            ...
            // 생성기 컴포넌트 상태 표시
            procGenerator = dungeonManager.GetComponent<ProceduralDungeonGenerator>();
            var improvedGen = dungeonManager.GetComponent<ImprovedDungeonGenerator>();
            var advancedGen = dungeonManager.GetComponent<AdvancedDungeonGenerator>();
        ...
        private void ValidateSingleDungeon()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    generationLog.Add("DungeonManager.GenerateNewDungeon() 사용");
                }
        ...
        {
            if (dungeonManager == null || procGenerator == null)
            {
        ...
        private void FindDungeonManager()
        {
            ...
            {
                procGenerator = dungeonManager.GetComponent<ProceduralDungeonGenerator>();
                generationLog.Add($"[{System.DateTime.Now:HH:mm:ss}] DungeonManager 발견: {dungeonManager.name}");
            }
            else
            {
                generationLog.Add($"[{System.DateTime.Now:HH:mm:ss}] DungeonManager를 찾을 수 없음");
            }
        }
